...
description = "Fileloom Adobe Illustrator AI parsing core"
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("fileloom-ai-core")
                description.set(project.description)
                url.set("https://github.com/beefiker/fileloom-ai-core")
                licenses {
                    license {
                ...
                scm {
                    url.set("https://github.com/beefiker/fileloom-ai-core")
                    connection.set("scm:git:https://github.com/beefiker/fileloom-ai-core.git")
                    developerConnection.set("scm:git:ssh://git@github.com:beefiker/fileloom-ai-core.git")
                }
            }
        }
    }
